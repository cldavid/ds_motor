...
WARNING_FLAGS = -w -Wall -Wstack-protector
...
ifeq ($(CPPFLAGS),)
    ...
    CPPFLAGS     += -fconserve-stack -fstack-protector-all -fstack-usage -fdump-tree-optimized
...
$(OBJDIR)/user/%.cpp.o: $(USER_LIB_PATH)/%.cpp
	...
	@mkdir -p $(dir $@)
	$(CXX) -c -Wall -Werror -Wextra $(CPPFLAGS) $(CXXFLAGS) $< $(OUT_PREPOSITION)$@
...
$(OBJDIR)/%.cpp.o: 	%.cpp
	...
	@mkdir -p $(dir $@)
	$(CXX) -c -Wall -Werror -Wextra $(CPPFLAGS) $(CXXFLAGS) -DBUILDTIME=$(BUILD_TIME) $< $(OUT_PREPOSITION)$@
...
# ----------------------------------
#
all: 		info message_all clean compile reset end_all prepare
